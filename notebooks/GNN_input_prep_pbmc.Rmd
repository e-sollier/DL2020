...
cmp_pbmc1 = ifelse(cmp_pbmc1 > 500, cmp_pbmc1, 0)
# cmp_pbmc1['CD14+ monocyte'] = 0
meta_sub_1 = cell_meta_1  %>%
    .[, .SD[sample(1:dim(.SD)[1], min(500, ..cmp_pbmc1[cell_type]))], by = 'cell_type']
...
ggm_pbmc1   = ggm(data_pbmc1, rho=.5, threshold =.05)
...
ggm_pbmc2   = ggm(data_pbmc2[, ..keep_genes], rho=0.3, threshold = .05)
## exclude isolated nodes
